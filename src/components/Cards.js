...
//   const { name, img, options, description } = item;
//   const pricePerItem = size === "Full" ? options[0].full : options[0].half;
//   const totalPrice = quantity * pricePerItem;
//   const clickHandler=async ()=>{
//     await dispatch({type:"Add",name:name,price:totalPrice,size:size,quantity:quantity})
//     console.log(data);
//   }
//   return (
...
//         style={{ height:"600px",width: "20rem", borderRadius: "15px" }}
//       >
//         {/* Food Image */}
...
//             alt={name}
//             style={{ height: "80%", objectFit: "fill", borderRadius: "12px" }}
//           />
//         </div>

//         {/* Price Display */}
//         <div className="text-center fw-bold mt-2 text-success fs-5">
//           Price: ₹{pricePerItem} per item
//         </div>
...
//             <button
//               className={`btn ${size === "Half" ? "btn-secondary" : "btn-outline-secondary"}`}
//               onClick={() => setSize("Half")}
//             >
//               Half
//             </button>
//             <button
//               className={`btn ${size === "Full" ? "btn-secondary" : "btn-outline-secondary"}`}
...
//           {/* Total Price Display */}
//           <div className="mt-3 p-2 text-center bg-light rounded fw-bold">
//             Total Price: ₹{totalPrice}
//           </div>
//           <button className="btn-success justify-centre mx-5 d-flex" onClick={clickHandler}>
//             Cart to Add
//           </button>
//         </div>
//       </div>
